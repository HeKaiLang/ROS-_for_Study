...
#include "base_interfaces/srv/detail/addints__rosidl_typesupport_fastrtps_c.h"
...
using _Addints_Request__ros_msg_type = base_interfaces__srv__Addints_Request;
...
size_t get_serialized_size_base_interfaces__srv__Addints_Request(
  const void * untyped_ros_message,
...
static uint32_t _Addints_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interfaces__srv__Addints_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces
size_t max_serialized_size_base_interfaces__srv__Addints_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Addints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces__srv__Addints_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces, srv, Addints_Request)() {
...
using _Addints_Response__ros_msg_type = base_interfaces__srv__Addints_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces
size_t get_serialized_size_base_interfaces__srv__Addints_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Addints_Response__ros_msg_type * ros_message = static_cast<const _Addints_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interfaces__srv__Addints_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces
size_t max_serialized_size_base_interfaces__srv__Addints_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Addints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces__srv__Addints_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces, srv, Addints_Response)() {
...
// already included above
// #include "base_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "base_interfaces/srv/addints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces, srv, Addints)() {
