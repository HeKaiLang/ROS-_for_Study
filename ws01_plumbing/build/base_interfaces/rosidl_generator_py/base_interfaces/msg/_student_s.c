...
bool base_interfaces__msg__student__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces.msg._student.Student", full_classname_dest, 36) == 0);
  }
  base_interfaces__msg__Student * ros_message = _ros_message;
  {  // name
...
PyObject * base_interfaces__msg__student__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces.msg._student");
