...
#include "base_interfaces/srv/detail/addints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces::srv::Addints_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::srv::Addints_Request & ros_message)
{
  // Member: num1
  cdr >> ros_message.num1;
...
{
  auto typed_message =
    static_cast<const base_interfaces::srv::Addints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces::srv::Addints_Request *>(
    untyped_ros_message);
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_Addints_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, Addints_Request)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_Addints_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_base_interfaces
cdr_serialize(
  const base_interfaces::srv::Addints_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::srv::Addints_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
...
{
  auto typed_message =
    static_cast<const base_interfaces::srv::Addints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_interfaces::srv::Addints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_Addints_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, Addints_Response)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_Addints_Response__handle;
}
...
{
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_Addints__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, srv, Addints)() {
  return &base_interfaces::srv::typesupport_fastrtps_cpp::_Addints__handle;
}
