...
#include "base_interfaces/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces::msg::Student & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::msg::Student & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const base_interfaces::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces::msg::Student *>(
    untyped_ros_message);
...
{
  return &base_interfaces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, msg, Student)() {
  return &base_interfaces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
