...
static rosidl_typesupport_introspection_c__MessageMember base_interfaces__msg__Student__rosidl_typesupport_introspection_c__Student_message_member_array[3] = {
  {
    "name",  // name
