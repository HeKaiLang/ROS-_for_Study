...
public:
  ...
  {}
  ::base_interfaces::action::Progress_Goal num(::base_interfaces::action::Progress_Goal::_num_type arg)
  {
...
{
  return base_interfaces::action::builder::Init_Progress_Goal_num();
}
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::base_interfaces::action::Progress_Result sum(::base_interfaces::action::Progress_Result::_sum_type arg)
  {
...
{
  return base_interfaces::action::builder::Init_Progress_Result_sum();
}
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::base_interfaces::action::Progress_Feedback progress(::base_interfaces::action::Progress_Feedback::_progress_type arg)
  {
...
{
  return base_interfaces::action::builder::Init_Progress_Feedback_progress();
}
