...
class Metaclass_Addints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from base_interfaces.srv import _addints
...
class Addints(metaclass=Metaclass_Addints):
    from base_interfaces.srv._addints import Addints_Request as Request
    from base_interfaces.srv._addints import Addints_Response as Response
